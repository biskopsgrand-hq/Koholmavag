...
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Budgetplan med inkomster, utgifter, kategorier och månadsbudget."
			},
			{
				name: "theme-color",
				content: "#efe9dc"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600&family=Schibsted+Grotesk:wght@400;500;600;700&display=swap"
			}
		]
	}),
